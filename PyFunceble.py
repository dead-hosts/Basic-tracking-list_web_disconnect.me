...
class Settings(object):  # pylint: disable=too-few-public-methods
    ...
    travis_autosave_final_commit = "[Results] Test of Basic-tracking-list"
    # Default travis commit message
    travis_autosave_commit = "[Autosave] Test of Basic-tracking-list"
    ...
    # Current directory.
    current_dir = '/home/travis/build/dead-hosts/Basic-tracking-list_web_disconnect.me/'
